    ...
    static class SieToCon
    {
        static public byte[] RequestExchange(byte[] pdubytes)
        {
            ...
            if (pdubytes.Length == 26)
            {
                ...
                header_ok = (pdubytes[0] == 0x32 && pdubytes[1] == 0x07 &&   
                        pdubytes[6] == 0x00 && pdubytes[7] == 0x08 &&        
                        pdubytes[8] == 0x00 && pdubytes[9] == 0x08);         
        ...
        static public void ResponseExchange(ref byte[] pdubytes)
        {
            ...
            if (pdubytes.Length == 20)
            {
                ...
                header_ok = (pdubytes[0] == 0x32 && pdubytes[1] == 0x03 &&     
                        pdubytes[6] == 0x00 && pdubytes[7] == 0x08 &&          
                        pdubytes[8] == 0x00 && pdubytes[9] == 0x00);           
